  ...
  return (
    <div className=" py-10 text-center dark:bg-dark">
      <ul className="flex items-center justify-center gap-2">
        <li>
          <button className="flex rounded-full h-10 min-w-10 items-center justify-center border border-stroke px-2 text-base font-medium text-dark hover:bg-gray-1 dark:border-white/10 dark:bg-gray-300 dark:text-gray-600 dark:hover:bg-blue-500">
            <span>
              <svg
                width="20"
                height="21"
        ...
        <li>
          <button className="flex h-10 min-w-10 items-center justify-center rounded-full border border-stroke bg-gray-300 px-2 text-base font-medium text-dark hover:bg-gray-1 dark:border-white/10 dark:bg-gray-300 dark:text-gray-600 dark:hover:bg-blue-500">
            1
          </button>
        </li>
        <li>
          <button className="flex h-10 min-w-10 items-center justify-center rounded-full border border-stroke bg-gray-100 px-2 text-base font-medium text-dark hover:bg-gray-1 dark:border-white/10 dark:bg-gray-300 dark:text-gray-600 dark:hover:bg-blue-500">
            2
          </button>
        </li>
        <li>
